...
# ============================================================
# СКОРОСТНОЙ ФИЛЬТР (болтанка при движении)
# ============================================================
# Если средняя скорость в окне выше порога → вероятно ложный слив
SPEED_FILTER_THRESHOLD_KMH = 15.0

# ============================================================
# CATBOOST — РЕЖИМЫ РАБОТЫ
# ============================================================
CATBOOST_SHADOW_LOG = True   # писать теневые предсказания в БД (включено везде)
CATBOOST_SHOW_UI = False      # показывать CatBoost в UI
                              # Локальная версия Виктора: True
                              # GitHub-версия для ТП: False
